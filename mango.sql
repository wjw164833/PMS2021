...
CREATE TABLE `sys_log`  (
  ...
  `last_update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2916 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统操作日志' ROW_FORMAT = Compact;
...
INSERT INTO `sys_log` VALUES (2897, NULL, NULL, 'com.louis.mango.admin.service.impl.SysUserServiceImpl.findByName()', '\"admin\"', 170, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL);
INSERT INTO `sys_log` VALUES (2898, NULL, NULL, 'com.louis.mango.admin.service.impl.SysUserServiceImpl.findByName()', '\"admin\"', 6, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL);
INSERT INTO `sys_log` VALUES (2899, NULL, NULL, 'com.louis.mango.admin.service.impl.SysMenuServiceImpl.findByUser()', '\"admin\"', 14, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL);
INSERT INTO `sys_log` VALUES (2900, NULL, NULL, 'com.louis.mango.admin.service.impl.SysUserServiceImpl.findPermissions()', '\"admin\"', 22, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL);
INSERT INTO `sys_log` VALUES (2901, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysLoginLogServiceImpl.writeLoginLog()', '\"admin\"', 90, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:21:51', NULL, NULL);
INSERT INTO `sys_log` VALUES (2902, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysMenuServiceImpl.findTree()', '\"admin\"', 14, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:21:52', NULL, NULL);
INSERT INTO `sys_log` VALUES (2903, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysUserServiceImpl.findByName()', '\"admin\"', 17, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:21:52', NULL, NULL);
INSERT INTO `sys_log` VALUES (2904, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysMenuServiceImpl.findByUser()', '\"admin\"', 8, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:21:52', NULL, NULL);
INSERT INTO `sys_log` VALUES (2905, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysUserServiceImpl.findPermissions()', '\"admin\"', 13, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:21:52', NULL, NULL);
INSERT INTO `sys_log` VALUES (2906, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysLoginLogServiceImpl.findPage()', '{\"pageNum\":1,\"pageSize\":10000000,\"params\":[{\"name\":\"status\",\"value\":\"login\"}]}', 118, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:21:52', NULL, NULL);
INSERT INTO `sys_log` VALUES (2907, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysLoginLogServiceImpl.findPage()', '{\"pageNum\":1,\"pageSize\":10000000,\"params\":[{\"name\":\"status\",\"value\":\"online\"}]}', 118, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:21:52', NULL, NULL);
INSERT INTO `sys_log` VALUES (2908, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysLoginLogServiceImpl.findPage()', '{\"pageNum\":1,\"pageSize\":9,\"params\":[{\"name\":\"userName\",\"value\":\"\"},{\"name\":\"status\",\"value\":\"online\"}]}', 6, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:22:39', NULL, NULL);
INSERT INTO `sys_log` VALUES (2909, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysMenuServiceImpl.findTree()', 'null', 9, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:23:05', NULL, NULL);
INSERT INTO `sys_log` VALUES (2910, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysRoleServiceImpl.findPage()', '{\"pageNum\":1,\"pageSize\":9,\"params\":[{\"name\":\"name\",\"value\":\"\"}]}', 8, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:23:20', NULL, NULL);
INSERT INTO `sys_log` VALUES (2911, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysMenuServiceImpl.findTree()', 'null', 6, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:23:20', NULL, NULL);
INSERT INTO `sys_log` VALUES (2912, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysDeptServiceImpl.findTree()', NULL, 6, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:23:36', NULL, NULL);
INSERT INTO `sys_log` VALUES (2913, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysDeptServiceImpl.findTree()', NULL, 5, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:23:38', NULL, NULL);
INSERT INTO `sys_log` VALUES (2914, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysUserServiceImpl.findPage()', '{\"pageNum\":1,\"pageSize\":9,\"params\":[{\"name\":\"name\",\"value\":\"\"}]}', 39, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:23:38', NULL, NULL);
INSERT INTO `sys_log` VALUES (2915, 'admin', NULL, 'com.louis.mango.admin.service.impl.SysRoleServiceImpl.findAll()', NULL, 3, '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:23:38', NULL, NULL);
...
INSERT INTO `sys_login_log` VALUES (2804, 'admin', 'logout', '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:21:51', NULL, NULL);
INSERT INTO `sys_login_log` VALUES (2805, 'admin', 'online', '0:0:0:0:0:0:0:1', 'admin', '2021-10-22 11:21:51', NULL, NULL);
